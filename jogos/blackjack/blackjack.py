...
* Se passar de 21 → estoura e perde.
* Se fizer exatamente 21 → ótimo, é a melhor pontuação possível.
...
* Ás (A) → vale 1 ou 11, você escolhe o valor que for mais vantajoso
...
Se fizer 17 ou mais → obrigatoriamente para
Se ultrapassar 21 → estoura e perde
